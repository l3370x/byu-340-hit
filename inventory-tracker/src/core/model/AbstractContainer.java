...
import static core.model.ModelNotification.ChangeType.CONTENT_ADDED;
import static core.model.ModelNotification.ChangeType.CONTENT_REMOVED;

/**
 * The {@code AbstractContainer} class is an abstract implementation of the {@link Container}
 * interface intended as a base class for concrete containers.
 *
 * @author kemcqueen
 * @invariant size() >= 0
 */
abstract class AbstractContainer<T extends Containable> extends Observable implements Container<T> {
    ...
    /**
     * This method is called by the {@link #canAdd(core.model.Containable)} method after it has
     * performed its initial checks;
     *
     * @param content the content to check
     * @return {@code true} if the given content can be added to this container, {@code false}
     *         otherwise
     */
    protected abstract boolean isAddable(T content);

    /**
     * This method is called by the {@link #add(core.model.Containable)} method after it has
     * performed its initial checks.
     *
    ...
    /**
     * This method is called by the {@link #canRemove(core.model.Containable)} method after it has
     * performed its initial checks;
     *
     * @param content the content to check
     * @return {@code true} if the given content can be removed from this container, {@code false}
     *         otherwise
     */
    protected abstract boolean isRemovable(T content);

    /**
     * This method is called by the {@link #remove(core.model.Containable)} method after it has
     * performed its initial checks.
     *
    ...
    /**
     * This method is called after content has been added to allow for any kind of specific
     * follow-up tasks.
     *
    ...
    /**
     * This method is called after content has been removed to allow for any kind of specific
     * follow-up tasks.
     *
    ...
    /**
     * Notifies this container that the given content was added to this container.  This method
     * differs from the {@link #didAdd(core.model.Containable)} method in that this method is called
     * as a result of receiving a {@code CONTENT_ADDED} update message. This implementation does
     * nothing.  Subclasses should not really need to override this method as they will most likely
     * override the {@code didAdd} method instead.
     *
     * @param content the content that was added
     */
    ...
    /**
     * Notifies this container that the given content was removed from this container.  This method
     * differs from the {@link #didRemove(core.model.Containable)} method in that this method is
     * called as a result of receiving a {@code CONTENT_REMOVED} update message. This implementation
     * does nothing.  Subclasses should not really need to override this method as they will most
     * likely override the {@code didRemove} method instead.
     *
     * @param content the content that was removed
     */
    ...
    /**
     * Notifies this container that the given content has been updated.  This indicates that some
     * internal state has changed which this container needs to be aware of.  This implementation
     * does nothing, leaving it to subclasses to override as necessary.
     *
     ...
     * it has been added to this container.  Implementations should call the content's {@link
     * Containable#wasAddedTo(core.model.Container) wasAddedTo} method.
     *
