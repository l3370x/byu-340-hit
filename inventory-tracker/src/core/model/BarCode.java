...
/**
 * The {@code BarCode} class provides a unique identifier for products (assigned by the
 * manufacturer) and items (generated internally) in the system.
 *
 * @author Andrew
 */
public class BarCode implements Serializable {
     ...
     * @throws HITException if the bar code could not be generated for any reason
     * @pre none
     */
     ...
     * @throws HITException if this bar code could not be written to the given stream for any
     *                      reason.
     * @pre null != stream
