...
public interface IRemovedReportView extends IView {
    ...
    /**
     * Sets the value of the "Since Last Value" field. (This is the date/time at which the report was
     * last run.)
     *
     * @param value New "Since Last Value"
     */
    ...
    /**
     * Returns the value of the "Since Date Value" field, or null if the field's value is invalid.
     * (This is the date/time entered by the user.)
     */
    Date getSinceDateValue();

    /**
     * Sets the value of the "Since Date Value" field. (This is the date/time entered by the user.)
     *
     * @param value New "Since Date Value"
     */
    ...
    /**
     * Sets the enable/disable state of the "Since Date Value" field. (This is the date/time entered by
     * the user.)
     *
     * @param value New enable/disable value
     */
